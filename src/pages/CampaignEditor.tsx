...
export default function CampaignEditor() {
  ...
  const computedSrcdocHtml = htmlForPreview
...
<\/script></body>`
  ...
  // Gate: skip srcdocHtml update when iframe owns HTML (undo/redo)
  const srcdocHtml = iframeOwnedHtmlRef.current ? prevSrcdocRef.current : computedSrcdocHtml;
  if (!iframeOwnedHtmlRef.current && computedSrcdocHtml) prevSrcdocRef.current = computedSrcdocHtml;
